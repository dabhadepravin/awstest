<div id="container">
	...
	<div class="loginform">
		...
		<div class="breathablewrap">
			...
			<div class="adtypes">
				<a href="<?php echo site_url()?>advertiser/bulkads">Bulk Ads</a>
			</div>
			<div class="adtypes">
				<a href="<?php echo site_url()?>advertiser/newcampaign">Premium Ads</a>
			</div>
	    <!--<form name="form1" id="form1" action="<?php echo site_url()?>users/login"  method="post" class="form standard noverify">
			<div class="reg">
