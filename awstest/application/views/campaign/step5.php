...
?>
    ...
    <div class="content nopadding ohidden">
	 ...
	 <div class="formfield">	 	
		...
		<div class="formfield">	 	
	 	...
	 	<div class="formfield filefield">	 	
	 		<label for="alt_text">Upload Creative</label><input class="pfileupload" c_width="<?php echo $a_width ?>" c_height="<?php echo $a_height?>" type="file" name="file" id="file" value="">
	 		<br>
	 		...
	 		<?php } ?>
	 		 ...
	 		 <div class="error-div-upload"  style="display:none">	 	
	 ...
	 <!--	<div class="formfield">	 	
	 	...
	 	<div class="">	 	
	 		<input  style="padding:10px" class="button green creative-upload-form" type="submit" value="Upload Creative" name="uploadcreative">
